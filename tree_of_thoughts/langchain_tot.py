...
def validate_sudoku(
    problem_description: str, thoughts: Tuple[str, ...], sudoku_solution: str
) -> ThoughtValidity:
...
langchain_tot = LangchainTOT(
    problem_description=problem_description, checker_class=lambda: my_checker
)
